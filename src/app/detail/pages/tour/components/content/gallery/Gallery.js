  ...
  render() {
    return (
      <>
        ...
        >
          <ImageGallery items={this.showGallery(this.props.images)} />
          <div className="shares dropdown">
            ...
            <ul className="share-wrapper">
              <li>
                <a
                  className="facebook"
                  href="https://www.facebook.com/sharer/sharer.php?u=st_tour/10-days-of-vacation-in-florence-resorts/&title=Northern California Summer 2019"
                  target="_blank"
                  rel="noopener"
              ...
              <li>
                <a
                  className="twitter"
                  href="https://twitter.com/share?url=st_tour/10-days-of-vacation-in-florence-resorts/&title=Northern California Summer 2019"
                  target="_blank"
                  rel="noopener"
              ...
              <li>
                <a
                  className="google"
                  href="https://plus.google.com/share?url=st_tour/10-days-of-vacation-in-florence-resorts/&title=Northern California Summer 2019"
                  target="_blank"
                  rel="noopener"
              ...
              <li>
                <a
                  className="linkedin"
                  href="https://www.linkedin.com/shareArticle?mini=true&url=st_tour/10-days-of-vacation-in-florence-resorts/&title=Northern California Summer 2019"
                  target="_blank"
                  rel="noopener"
