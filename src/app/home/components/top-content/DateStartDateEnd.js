...
class DateStartDateEnd extends Component {
  ...
  render() {
    ...
    this.props.postDate(moment(this.state.startValue).format("DD/MM/YYYY"), moment(this.state.endValue).format("DD/MM/YYYY"), this.props.typeSearch)
...
export default DateStartDateEnd;